...
export const metadata: Metadata = {
  title: 'Contact',
  description: 'Contact Almas for wholesale orders, retail purchases, or any questions. Fast response via WhatsApp.',
  openGraph: { title: 'Contact Almas', description: 'Get in touch for wholesale or retail spice orders.' },
}
        ...
        <div className="grid md:grid-cols-2 gap-14">
          ...
          <div>
            ...
            <div className="space-y-5">
              {[
                { icon: '💬', label: 'WhatsApp (Fastest)', value: '{SITE.phone}', href: '{WA('Bonjour Almas, je voudrais passer une commande.')}', cta: 'Message Now' },
                { icon: '📞', label: 'Phone', value: '{SITE.phone}', href: 'tel:+212600000000', cta: 'Call Now' },
                { icon: '✉️', label: 'Email', value: '{SITE.email}', href: 'mailto:{SITE.email}', cta: 'Send Email' },
          ...
          <div>
            ...
            <div className="bg-white rounded-3xl p-8 border border-[#1A1A2E]/8 shadow-sm">
              ...
              <a href="{WA('Bonjour Almas, je voudrais passer une commande.')}?text=Hello Almas, I'd like to place an order."
                target="_blank"
