...
export default function WhatsAppButton() {
  return (
    <a
      href={WA('Bonjour, je suis intéressé par vos produits Almas')}
      target="_blank"
      rel="noopener noreferrer"
      className="fixed bottom-6 right-6 z-50 bg-[#25D366] text-white rounded-full w-14 h-14 flex items-center justify-center shadow-lg hover:bg-[#1ebe57] hover:scale-110 transition-all"
